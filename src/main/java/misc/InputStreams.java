...
/**
 * Helper class for dealing with {@link InputStream}s. Provides some newer JDK
 * methods.
 */
public final class InputStreams {
     ...
     * This method invokes {@link #readNBytes(InputStream, int)} with a length
    ...
    public static int readNBytes(InputStream is, byte[] b, int off, int len) throws IOException {
        Utils.checkFromIndexSize(off, len, b.length);
        int n = 0;
        while (n < len) {
