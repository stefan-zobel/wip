...
public final class ArraysSupport {
    static final Unsafe U = Unaligned.U;

    private static final boolean BIG_ENDIAN = Unaligned.BIG_ENDIAN;
    ...
    public static int vectorizedMismatch(Object a, long aOffset,
        ...
        for (; wi < length >> log2ValuesPerWidth; wi++) {
            ...
            long av = Unaligned.getLongUnaligned(a, aOffset + bi);
            long bv = Unaligned.getLongUnaligned(b, bOffset + bi);
            if (av != bv) {
                long x = av ^ bv;
                int o = BIG_ENDIAN
        ...
        if (log2ArrayIndexScale < LOG2_ARRAY_INT_INDEX_SCALE) {
            ...
            if (tail >= wordTail) {
                long bi = ((long) wi) << LOG2_ARRAY_LONG_INDEX_SCALE;
                int av = Unaligned.getIntUnaligned(a, aOffset + bi);
                int bv = Unaligned.getIntUnaligned(b, bOffset + bi);
                if (av != bv) {
                    int x = av ^ bv;
                    int o = BIG_ENDIAN
