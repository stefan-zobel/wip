 ...
 * (Modified to use AtomicLongFieldUpdater instead of sun.misc.Unsafe)
 * See also:
 * http://code.google.com/p/guava-libraries/source/browse/guava/src/com/google/common/util/concurrent/AtomicDouble.java
 */
package misc;
 ...
 * {@code java.util.concurrent.atomic} package specification for description of
