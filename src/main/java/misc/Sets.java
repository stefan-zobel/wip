...
public final class Sets {
     ...
     * of the resulting set will be the component type of the array, and the
     * size of the set will be equal to the length of the array. To create a set
     * with a single element that is an array, do the following:
     *
     * <pre>
     * {@code
     *     String[] array = ... ;
     ...
     * </pre>
     *
     * This will cause the {@link Sets#of(Object) Sets.of(E)} method to be
     * invoked instead.
     *
     * @param <E>
     *            the {@code Set}'s element type
    ...
    /**
     * Returns an <a href="#unmodifiable">unmodifiable Set</a> containing the
     * elements of the given Collection. The given Collection must not be null,
     * and it must not contain any null elements. If the given Collection
     * contains duplicate elements, an arbitrary element of the duplicates is
     * preserved. If the given Collection is subsequently modified, the returned
     * Set will not reflect such modifications.
     *
     * <p>
     * <b>Implementation Note:</b> If the given Collection is an
     * <a href="#unmodifiable">unmodifiable Set</a>, calling copyOf will
     ...
     * @return a {@code Set} containing the elements of the given
     *         {@code Collection}
     * @throws NullPointerException
